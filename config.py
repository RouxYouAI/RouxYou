...
class _Config:
    ...
    # Authoring/enrichment model (the fine-tuned Ministral voice, GGUF via Ollama).
    # Used by the coach enricher. Was borrowing MODEL_ROUTER, whose value
    # ("ministral-3:8b") went stale in the GGUF migration → 404. 2026-05-25.
    MODEL_AUTHORING = _raw.get("models", {}).get("authoring", "authoring-ministral:latest")
